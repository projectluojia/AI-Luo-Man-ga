...
generate:
	...
	$(AGENT_PYTHON) -m grpc_tools.protoc -I proto --go_out=contracts --go_opt=module=$(CONTRACTS_MODULE) --go-grpc_out=contracts --go-grpc_opt=module=$(CONTRACTS_MODULE) proto/runtime_host.proto
