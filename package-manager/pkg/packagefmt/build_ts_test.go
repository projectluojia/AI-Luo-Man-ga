...
`
	...
	manifest := packagecontract.Manifest{
		...
		Components: []packagecontract.Component{{ID: "main", Mode: packagecontract.ModeHosted, ABIVersion: packagecontract.GuestABI1, Role: packagecontract.RoleProvider, Entrypoint: "main.wasm"}},
	}
