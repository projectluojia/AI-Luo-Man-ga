...
type StartRun struct {
	...
	// 当前 Echo 下仍然活跃（waiting/approved 且未过期）的确认投影，
	// 供执行者在重试高风险调用时附带 confirmation_id。
	PendingConfirmations []*ConfirmationInfo `protobuf:"bytes,19,rep,name=pending_confirmations,json=pendingConfirmations,proto3" json:"pending_confirmations,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *StartRun) GetPendingConfirmations() []*ConfirmationInfo {
	if x != nil {
		return x.PendingConfirmations
	}
	return nil
}

// ConfirmationInfo 是确认记录面向执行者的公共投影：只包含呈现与重试所需字段，
// 不包含参数原文、参数摘要或决策人等治理细节。
...
func (x *ConfirmationInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfirmationInfo) ProtoMessage() {}

func (x *ConfirmationInfo) ProtoReflect() protoreflect.Message {
	mi := &file_proto_executor_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfirmationInfo.ProtoReflect.Descriptor instead.
func (*ConfirmationInfo) Descriptor() ([]byte, []int) {
	return file_proto_executor_proto_rawDescGZIP(), []int{4}
}

func (x *ConfirmationInfo) GetConfirmationId() string {
	if x != nil {
...
func (x *ConfirmationInfo) GetCapabilityId() string {
	if x != nil {
...
func (x *ConfirmationInfo) GetTargetType() string {
	if x != nil {
		return x.TargetType
	}
	return ""
...
func (x *ConfirmationInfo) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
func (x *ConfirmationInfo) GetSideEffect() string {
	if x != nil {
		return x.SideEffect
	}
	return ""
...
func (x *ConfirmationInfo) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ConfirmationInfo) GetExpiresAt() string {
	if x != nil {
		return x.ExpiresAt
	}
	return ""
...
type CapabilityCall struct {
	...
	// 重试高风险调用时携带的已批准确认标识；首次调用留空。
	ConfirmationId string `protobuf:"bytes,4,opt,name=confirmation_id,json=confirmationId,proto3" json:"confirmation_id,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CapabilityCall) GetConfirmationId() string {
	if x != nil {
		return x.ConfirmationId
	}
	return ""
...
type CapabilityResult struct {
	...
	// error_code 为 confirmation_required 时携带新建确认的公共投影。
	Confirmation  *ConfirmationInfo `protobuf:"bytes,7,opt,name=confirmation,proto3" json:"confirmation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CapabilityResult) GetConfirmation() *ConfirmationInfo {
	if x != nil {
...
const file_proto_executor_proto_rawDesc = "" +
	"\n" +
	"\x14proto/executor.proto\x12\x11ailuo.executor.v1\"c\n" +
	"\rHealthRequest\x12<\n" +
	...
	"\rparent_run_id\x18\x12 \x01(\tR\vparentRunId\x12X\n" +
	"\x15pending_confirmations\x18\x13 \x03(\v2#.ailuo.executor.v1.ConfirmationInfoR\x14pendingConfirmations\"\xf6\x01\n" +
	"\x10ConfirmationInfo\x12'\n" +
	...
	"\vside_effect\x18\x05 \x01(\tR\n" +
	"sideEffect\x12\x16\n" +
	"\x06status\x18\x06 \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"expires_at\x18\a \x01(\tR\texpiresAt\"8\n" +
	"\vRunAccepted\x12)\n" +
	...
	"\x11input_schema_json\x18\x05 \x01(\tR\x0finputSchemaJson\"\x9a\x01\n" +
	...
	"\x0fconfirmation_id\x18\x04 \x01(\tR\x0econfirmationId\"\x9a\x02\n" +
	...
	"\fconfirmation\x18\a \x01(\v2#.ailuo.executor.v1.ConfirmationInfoR\fconfirmation\" \n" +
	"\n" +
	"ReplyDelta\x12\x12\n" +
...
var file_proto_executor_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_executor_proto_goTypes = []any{
	...
	(*ConfirmationInfo)(nil), // 4: ailuo.executor.v1.ConfirmationInfo
	(*RunAccepted)(nil),      // 5: ailuo.executor.v1.RunAccepted
	(*RunUsage)(nil),         // 6: ailuo.executor.v1.RunUsage
	(*Capability)(nil),       // 7: ailuo.executor.v1.Capability
	(*CapabilityCall)(nil),   // 8: ailuo.executor.v1.CapabilityCall
	(*CapabilityResult)(nil), // 9: ailuo.executor.v1.CapabilityResult
	(*ReplyDelta)(nil),       // 10: ailuo.executor.v1.ReplyDelta
	(*FinalMessage)(nil),     // 11: ailuo.executor.v1.FinalMessage
...
var file_proto_executor_proto_depIdxs = []int32{
	...
	8,  // 1: ailuo.executor.v1.ExecutorFrame.capability_call:type_name -> ailuo.executor.v1.CapabilityCall
	9,  // 2: ailuo.executor.v1.ExecutorFrame.capability_result:type_name -> ailuo.executor.v1.CapabilityResult
	10, // 3: ailuo.executor.v1.ExecutorFrame.reply_delta:type_name -> ailuo.executor.v1.ReplyDelta
	11, // 4: ailuo.executor.v1.ExecutorFrame.final_message:type_name -> ailuo.executor.v1.FinalMessage
	...
	5,  // 7: ailuo.executor.v1.ExecutorFrame.run_accepted:type_name -> ailuo.executor.v1.RunAccepted
	6,  // 8: ailuo.executor.v1.ExecutorFrame.run_usage:type_name -> ailuo.executor.v1.RunUsage
	7,  // 9: ailuo.executor.v1.StartRun.capabilities:type_name -> ailuo.executor.v1.Capability
	4,  // 10: ailuo.executor.v1.StartRun.pending_confirmations:type_name -> ailuo.executor.v1.ConfirmationInfo
	4,  // 11: ailuo.executor.v1.CapabilityResult.confirmation:type_name -> ailuo.executor.v1.ConfirmationInfo
	2,  // 12: ailuo.executor.v1.ExecutorRuntime.Run:input_type -> ailuo.executor.v1.ExecutorFrame
	0,  // 13: ailuo.executor.v1.ExecutorRuntime.Health:input_type -> ailuo.executor.v1.HealthRequest
	2,  // 14: ailuo.executor.v1.ExecutorRuntime.Run:output_type -> ailuo.executor.v1.ExecutorFrame
	1,  // 15: ailuo.executor.v1.ExecutorRuntime.Health:output_type -> ailuo.executor.v1.HealthResponse
