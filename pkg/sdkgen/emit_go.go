...
func emitGo(packageID string, capabilities []capabilitySpec, models map[string]*TypeModel) []Generated {
...
func goCapability(builder *strings.Builder, capability capabilitySpec, model *TypeModel, packageID string) {
